...
<html lang="en">
    ...
    <body>
      ...
      <!-- MESSAGE BOX-->
        ...
        <!-- START SCRIPTS -->
        <!-- START PLUGINS -->
        <script type="text/javascript" src="{{ URL('estilos/sistema/js/plugins/jquery/jquery.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL('estilos/sistema/js/plugins/jquery/jquery-ui.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL('estilos/sistema/js/plugins/bootstrap/bootstrap.min.js') }}"></script>        
        <!-- END PLUGINS -->
        ...
        <script type="text/javascript" src="{{ URL('estilos/sistema/js/plugins/morris/morris.min.js') }}"></script>       
